            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                <div className="animate-fade-in">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4">
                        <button
                            onClick={onOpenModal}
                            className="px-8 py-4 bg-primary-800 text-white rounded-full font-bold text-lg hover:bg-primary-900 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center"
                        >
                            Get in Touch
