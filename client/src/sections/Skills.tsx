    ...
    const skillCategories = [
        {
            ...
            skills: ["React", "TypeScript", "TailwindCSS", "Next.js", "HTML5/CSS3", "Redux"]
        },
        {
            title: "Backend",
    ...
    return (
        <section id="skills" className="py-24 bg-white">
            <div className="container mx-auto px-6">
                <SectionTitle title="Skills & Expertise" subtitle="My technical toolbelt" />

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 reveal">
                    {skillCategories.map((category, index) => (
                        <div key={index} className="bg-primary-50 rounded-2xl p-8 border border-primary-100 hover:border-primary-300 transition-all duration-300 hover:shadow-lg">
