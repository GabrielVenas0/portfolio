  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a
          href="#"
          className="text-2xl font-bold text-primary-800 tracking-tighter"
        >
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <button
            onClick={onOpenModal}
            className="px-5 py-2 bg-primary-800 text-primary-100 rounded-full font-medium hover:bg-primary-900 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Contact
          </button>
        </nav>
