  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 reveal group">
      <div className="h-48 bg-primary-200 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-primary-900/0 group-hover:bg-primary-900/15 transition-all duration-300 flex items-start pt-2 justify-center opacity-0 group-hover:opacity-100 space-x-2">
          {githubUrl && (
            <a
              href={githubUrl}
              className="p-1.5 bg-white rounded-full text-primary-900 hover:bg-primary-100 transition-colors"
              title="View Code"
            >
              <Github size={20} />
            </a>
